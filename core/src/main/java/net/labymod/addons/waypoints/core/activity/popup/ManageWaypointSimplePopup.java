...
import net.labymod.addons.waypoints.core.activity.widgets.NumberTextFieldWidget;
...
public class ManageWaypointSimplePopup extends SimpleAdvancedPopup {
  ...
  protected void initializeCustomWidgets(VerticalListWidget<Widget> container) {
    ...
    nameWrapper.addContent(this.createLabeledWidget(
        Component.text("Icon"),
        () -> {
          DropdownWidget<WaypointIcon> iconDropdown = new DropdownWidget<>();
          iconDropdown.addAll((Collection<WaypointIcon>) WaypointIcon.getSelectableIcons());
